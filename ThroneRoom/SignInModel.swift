...
struct UserProfile {
    ...
    init(userId: String, displayName: String, fullName: String, email: String, city: String, photoURL:String, bio: String, state: String, groupName: String, joinedDate: String) {
        self.userId = userId
